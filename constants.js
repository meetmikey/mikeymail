...
define('MARKETING_FROM', 'from:(notify@ OR notification@ OR notifications@ OR @proxyvote.com OR bounces@ OR bounce@ OR pinbot@ OR reservation@ OR booking@ OR bookings@ OR newsletter@ OR elert@ OR do-not-reply@ OR notifier@ OR nagios@ OR noreply@ OR no-reply@ OR @facebookmail.com OR auto-confirm@ OR support@ OR service@ OR contact@ OR info@ OR member@ OR confirmation@ OR paypal@ OR edelivery@ OR marketing@ OR reply@ OR reservations@)');