...
exports.start = function () {
  ...
  mongoPoll.startPollingResumeDownload(function (err, foundResumeTask) {
    ...
    if (err) {
      ...
      winston.info ('No accounts to resume downloading');
    }
    else {
        ...
        if (err) {
          ...
          mongoPoll.setWorkingTimestampLoop (ResumeDownloadStateModel,
            ...
            function (err, intervalId) {
              if (err) { 
                ...
                setTimestampIntervalIds [foundResumeTask.userId] = intervalId;
              }
            });
          ...
          xoauth2gen.getToken(function(err, token) {
            if(err){
              ...
              mongoPoll.clearTimeIntervalLoop (foundResumeTask.userId, setTimestampIntervalIds, 'resumeDownloadDaemon');
              return;
            }
...
exports.resumeDownloading = function (userInfo, myConnection, mailbox, foundResumeTask, pollMongoCallback) {
  ...
  // TODO: incorporate a "recovery" mode here
