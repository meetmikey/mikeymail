...
exports.openMailbox = function (imap, userEmail, cb) {
  ...
  imap.once('error', function(err) {
    if (callbackCalled) {
      winston.doError ('imap open boxes callback already called!', {err : err, email : userEmail});
      winston.doWarn ('imap open boxes callback already called!', {err : err, email : userEmail});
