...
exports.getHeaders = function (argDict, minUid, maxUid, uidArray, callback) {
  ...
  var fetch = imapConn.seq.fetch(uidQuery, {
...
exports.fetchMsgBodies = function (imapConn, uidArray, userId, isUpdate, getAllMessagesCallback) {
  winston.doInfo ('fetchMsgBodies', {userId : userId, uidArray : uidArray});
  ...
  var bandwithUsed = 0;
    ...
    var fetch = imapConn.seq.fetch(uidArray, { bodies: [''], size: true });
