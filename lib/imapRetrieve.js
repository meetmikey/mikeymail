        ...
        cb: function(fetch) {
          ...
          fetch.on('message', function(msg) {
            ...
            msg.on('end', function() {
              ...
              if (!imapRetrieve.checkLabelIsInvalid (mailObject)) {
...
exports.checkLabelIsInvalid = function (mailObject) {  
  var isInvalid = false;
  ...
  if (mailObject.gmLabels && mailObject.gmLabels.length) {
    try {
      ...
      mailObject.gmLabels.forEach (function (label) {
        ...
        winston.doInfo ('the gmLabel', {label : label});
        ...
        if (labelStripped === 'trash' || labelStripped === 'draft' || labelStripped === 'spam') {
          isInvalid = true;
        }
      });
    }
    catch (e) {
      winston.doError ('error checkLabelIsInvalid', {stack : e.stack, message : e.message});
    }
  }
