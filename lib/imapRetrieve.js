      ...
      cb: function(fetch) {
        ...
        fetch.on('message', function(msg) {
          ...
          msg.on('headers', function(hdrs) {
            ...
            console.log (hdrs)
            console.log (mailUtils.getSender (hdrs))
            console.log (mailUtils.getAllRecipients (hdrs))
...
exports.getMessagesByUid = function (imapConn, userId, messages, getAllMessagesCallback) {
  ...
  if (messageIds.length === 0) {
    ...
    imapRetrieve.fetchMsgBodies (imapConn, messageIds, userId, getAllMessagesCallback)
  }
...
exports.fetchMsgBodies = function (imapConn, uidArray, userId, getAllMessagesCallback) {
      ...
      cb: function(fetch) {
        fetch.on('message', function(msg) {
          ...
          fileStream.on('close' , function () {
            ...
            uploadUtils.uploadFileToS3 (filename, awsPath, headers, userId, msg.uid, 0)
