...
exports.mapReduceContacts = function mapReduceContacts (argDict, callback) {
  ...
  var o = {scope : {userEmail : userEmail}};
  ...
  o.reduce = function (key, values) { 
    reducedValue = {sent : 0, corecipient : 0}
  ...
  //db.mails.mapReduce (map, reduce, {out : "contacts"})
...
exports.mapReduceReceiveCounts = function mapReduceReceiveCounts (argDict, callback) {
  ...
  o.reduce = function (key, value) { return Array.sum(value); }
