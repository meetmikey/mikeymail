...
exports.retrieveBatchRecurse = function (query, argDict, maxDateBatch, callback) {
  ...
  var logInfo = {minDate : argDict.minDateToProcess, maxDate: maxDateBatch, minUid : argDict.minUid};
  ...
  mongoQuery.where ('gmDate').gte (argDict.minDateToProcess.getTime());
  ...
  mongoQuery.exec (function (err, messages) {
    if (err) {
      ...
      if (!msgToDownloadLength && newMaxDate.getTime() == maxDateBatch.getTime()) {
