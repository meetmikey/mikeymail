...
exports.establishConnectionAndUpdate = function (userInfo, xoauth2gen, pollQueueCallback) {
  xoauth2gen.getToken(function(err, token) {
    ...
    imapConnect.openMailbox (myConnection, function (err, mailbox) {
      ...
      mailUpdateDaemon.updateMailbox (userInfo, myConnection, mailbox, keepMailboxOpen=true, pollQueueCallback)
    })
 ...
 */
exports.updateMailbox = function (userInfo, myConnection, mailbox, keepMailboxOpen, pollQueueCallback) {
