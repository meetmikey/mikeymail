...
exports.start = function () {
  ...
  sqsConnect.pollMailUpdateQueue(function (message, pollQueueCallback) {
    ...
    updateMailbox (userInfo, xoauth2gen, pollQueueCallback)
...
function establishConnectionAndUpdate (userInfo, xoauth2gen, pollQueueCallback) {

}

/*
 * Polls mailbox onboarding for user
 *
 * Parameters:
 ...
 */
function updateMailbox (userInfo, xoauth2gen, pollQueueCallback) {
